 ...
 */
export function calculatePropagationFactor(affectedNodes: number, totalNodes: number): number {
...
export function calculateChangeEntropy(
  ...
  const baseEntropy = structuralWeight * structuralEntropy + semanticWeight * semanticEntropy;
 ...
 */
export function isSignificantChange(delta: number, threshold = 0.1): boolean {
