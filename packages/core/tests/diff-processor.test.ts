...
describe('DiffProcessor', () => {
  ...
  describe('diff', () => {
    it('should detect no changes for identical nodes', () => {
      const nodes: SemanticNode[] = [createSemanticNode('function', 'myFunc', [])];
    ...
    it('should detect added nodes', () => {
      ...
      const newNodes: SemanticNode[] = [createSemanticNode('function', 'newFunc', [])];
    ...
    it('should detect removed nodes', () => {
      const oldNodes: SemanticNode[] = [createSemanticNode('function', 'oldFunc', [])];
  ...
  describe('compareTrees', () => {
    it('should find added Merkle nodes', () => {
      ...
      const newTrees: MerkleNode[] = [createMerkleNode('function', 'newFunc', [])];
    ...
    it('should find removed Merkle nodes', () => {
      const oldTrees: MerkleNode[] = [createMerkleNode('function', 'oldFunc', [])];
    ...
    it('should find modified nodes by hash difference', () => {
      const oldTrees: MerkleNode[] = [createMerkleNode('function', 'myFunc', [], 'hash1')];
      const newTrees: MerkleNode[] = [createMerkleNode('function', 'myFunc', [], 'hash2')];
  ...
  describe('options', () => {
    ...
    it('should respect maxChangeDepth option', () => {
      ...
      const deepTree = createMerkleNode('module', 'mod', [
        createMerkleNode('class', 'cls', [createMerkleNode('function', 'func', [])]),
      ]);

      // Should still process but limit depth
      const result = shallowProcessor.diff([semanticFromMerkle(deepTree)], []);
