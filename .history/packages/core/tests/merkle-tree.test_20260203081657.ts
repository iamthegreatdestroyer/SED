...
describe('MerkleTreeBuilder', () => {
  ...
  describe('hash consistency', () => {
    ...
    it('should reflect child changes in parent hash', () => {
      ...
      // Child hash differs
      expect(tree1[0].children[0].merkleHash).not.toBe(
        tree2[0].children[0].merkleHash
      );
  ...
  describe('compareNodes', () => {
    it('should detect identical nodes', () => {
      const node: SemanticNode[] = [
        createSemanticNode('function', 'func', 'content', []),
      ];
    ...
    it('should detect content changes', () => {
      const node1 = builder.buildTree([
        createSemanticNode('function', 'func', 'original', []),
      ])[0];
      const node2 = builder.buildTree([
        createSemanticNode('function', 'func', 'modified', []),
      ])[0];
