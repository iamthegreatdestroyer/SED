...
It spans multiple lines.`;
  ...
  describe('getTypeStats', () => {
    it('should count commits by type', async () => {
      const logs: LogEntry[] = [
        { hash: 'a', abbreviatedHash: 'a', author: '', authorEmail: '', date: new Date(), message: 'feat: f1', body: '', refs: [] },
        { hash: 'b', abbreviatedHash: 'b', author: '', authorEmail: '', date: new Date(), message: 'feat: f2', body: '', refs: [] },
        { hash: 'c', abbreviatedHash: 'c', author: '', authorEmail: '', date: new Date(), message: 'fix: b1', body: '', refs: [] },
        { hash: 'd', abbreviatedHash: 'd', author: '', authorEmail: '', date: new Date(), message: 'Random', body: '', refs: [] },
      ];
  ...
  describe('getBreakingChanges', () => {
    it('should return only breaking change commits', async () => {
      const logs: LogEntry[] = [
        { hash: 'a', abbreviatedHash: 'a', author: '', authorEmail: '', date: new Date(), message: 'feat: normal', body: '', refs: [] },
        { hash: 'b', abbreviatedHash: 'b', author: '', authorEmail: '', date: new Date(), message: 'feat!: breaking', body: '', refs: [] },
        { hash: 'c', abbreviatedHash: 'c', author: '', authorEmail: '', date: new Date(), message: 'fix: normal fix', body: '', refs: [] },
      ];
  ...
  describe('filterByType', () => {
    it('should filter commits by type', async () => {
      const logs: LogEntry[] = [
        { hash: 'a', abbreviatedHash: 'a', author: '', authorEmail: '', date: new Date(), message: 'feat: f1', body: '', refs: [] },
        { hash: 'b', abbreviatedHash: 'b', author: '', authorEmail: '', date: new Date(), message: 'fix: b1', body: '', refs: [] },
        { hash: 'c', abbreviatedHash: 'c', author: '', authorEmail: '', date: new Date(), message: 'docs: d1', body: '', refs: [] },
      ];
  ...
  describe('filterByScope', () => {
    it('should filter commits by scope', async () => {
      const logs: LogEntry[] = [
        { hash: 'a', abbreviatedHash: 'a', author: '', authorEmail: '', date: new Date(), message: 'feat(core): f1', body: '', refs: [] },
        { hash: 'b', abbreviatedHash: 'b', author: '', authorEmail: '', date: new Date(), message: 'fix(api): b1', body: '', refs: [] },
        { hash: 'c', abbreviatedHash: 'c', author: '', authorEmail: '', date: new Date(), message: 'feat: no scope', body: '', refs: [] },
      ];
  ...
  describe('generateChangelog', () => {
    it('should generate flat changelog', async () => {
      const logs: LogEntry[] = [
        { hash: 'abc123', abbreviatedHash: 'abc', author: '', authorEmail: '', date: new Date(), message: 'feat: feature 1', body: '', refs: [] },
        { hash: 'def456', abbreviatedHash: 'def', author: '', authorEmail: '', date: new Date(), message: 'fix: bug fix', body: '', refs: [] },
      ];
    ...
    it('should generate grouped changelog', async () => {
      const logs: LogEntry[] = [
        { hash: 'a', abbreviatedHash: 'a', author: '', authorEmail: '', date: new Date(), message: 'feat: new feature', body: '', refs: [] },
        { hash: 'b', abbreviatedHash: 'b', author: '', authorEmail: '', date: new Date(), message: 'fix: bug fix', body: '', refs: [] },
        { hash: 'c', abbreviatedHash: 'c', author: '', authorEmail: '', date: new Date(), message: 'docs: documentation', body: '', refs: [] },
        { hash: 'd', abbreviatedHash: 'd', author: '', authorEmail: '', date: new Date(), message: 'feat!: breaking feature', body: '', refs: [] },
      ];
    ...
    it('should handle commits with scopes in grouped changelog', async () => {
      const logs: LogEntry[] = [
        { hash: 'a', abbreviatedHash: 'a', author: '', authorEmail: '', date: new Date(), message: 'feat(auth): login feature', body: '', refs: [] },
      ];
  ...
  describe('options', () => {
    ...
    it('should disable conventional parsing', async () => {
      ...
      const logs: LogEntry[] = [
        { hash: 'a', abbreviatedHash: 'a', author: '', authorEmail: '', date: new Date(), message: 'feat: feature', body: '', refs: [] },
      ];
