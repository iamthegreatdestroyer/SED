  ...
  <div class="container">
    ...
    <section class="section">
      ...
      <div style="display: flex; justify-content: space-between; margin-top: 1rem;">
        ${Object.entries(data.summary.classifications).map(([cls, count]) => `
    ...
    <section class="section">
      ...
      <table>
        ...
        <tbody>
          ${data.summary.highestImpact.map(file => `
            <tr>
          ...
          ${data.files.map(file => {
            ...
            return `
              <tr>
                ...
                <td>
                  ${file.error ? '<span style="color: #EF4444;">Failed</span>' : `
...
function generateClassificationBar(
  ...
  if (total === 0) return '<div class="classification-bar" style="background: #E5E7EB;">No data</div>';
