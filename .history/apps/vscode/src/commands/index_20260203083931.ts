...
export function registerCommands(
  ...
  const { analysisService, decorationManager, statusBarManager, changesProvider, summaryProvider, historyProvider, logger } = services;
    ...
    vscode.commands.registerCommand('sed.generateReport', async () => {
      ...
      try {
        ...
        const reportPath = await analysisService.generateReport(
          workspaceFolder.uri.fsPath,
          { format, title: title || 'SED Analysis Report', includeChanges: true, includeCommits: true },
        );
